...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            #Creating the Numercal Pipeline
            # Steps for filling the missing values,onehotencoder for categorical variables and standard scaling
            ...
            #Initiate the Column Transformer
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("Read train data ans test data completed")
